...
> [중요] **2026-09-13 보강.** 그 전까지 이 표에는 **Pretendard 하나만** 적혀 있었습니다.
...
- **앱 안에 ‘오픈소스 라이선스’ 화면이 없습니다.** 법적 필수는 아니지만 BSD·MIT·OFL은
  ...
  [중요] 다만 **사규 ‘동작하지 않는 버튼은 그리지 않는다’**에 따라, 화면을 실제로 붙인 뒤에
  이 줄을 지워야 합니다.
...
> **2026-09-19 — 표시 문자만 바꿨어요.** 앱 글꼴(Pretendard)에 없어서 화면에 **빈칸으로** 그려지던 글자 8자리를 뜻이 같은 글자·말로 옮겼습니다 — 꺾쇠 따옴표(U+300C·U+300D) → 작은따옴표 ‘ ’ · 빨간 동그라미(U+1F534) → [중요]. **고지 대상 구성요소와 라이선스 판정은 한 자도 바뀌지 않았습니다.**
